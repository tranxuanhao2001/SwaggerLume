...
return [
		...
		'controller' => [
				/*
				 |--------------------------------------------------------------------------
				 | Method name used by route for accessing api documentation interface
				 |--------------------------------------------------------------------------
				 */
				'api' => 'SwaggerController@interface',
				/*
				 |--------------------------------------------------------------------------
				 | Method name used by route for accessing parsed swagger annotations.
				 |--------------------------------------------------------------------------
				 */
				'docs' => 'SwaggerController@doc',
		],
		...
		'paths' => [
				...
				/*
				 |--------------------------------------------------------------------------
				 | Absolute path to directory where to export controller
				 |--------------------------------------------------------------------------
				 */
