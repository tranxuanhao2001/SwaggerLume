...
use SwaggerLume\Console\PublishControllerCommand;
...
class ServiceProvider extends BaseProvider
{
	...
	public function register()
	{
		...
		$this->app['command.swagger-lume.publish-controller'] = $this->app->share(
				function () {
					return new PublishControllerCommand();
				}
				);
		...
		$this->commands(
				...
				'command.swagger-lume.publish-controller',
