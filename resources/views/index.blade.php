...
<head>
    ...
    <script src='{{config('swagger-lume.paths.assets_public')}}/lib/object-assign-pollyfill.js' type='text/javascript'></script>
    ...
    <script src='{{config('swagger-lume.paths.assets_public')}}/lib/js-yaml.min.js' type='text/javascript'></script>
    ...
    <script src='{{config('swagger-lume.paths.assets_public')}}/lib/highlight.9.1.0.pack.js' type='text/javascript'></script>
    <script src='{{config('swagger-lume.paths.assets_public')}}/lib/highlight.9.1.0.pack_extended.js' type='text/javascript'></script>
